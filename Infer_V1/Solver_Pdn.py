...
def Solver_Pdn(theta, nmrec=115): 
    """
    ...
    class Q_rhs(StateRHS):
        ...
        def __init__( self ):
            ...
            self.AddVar( typ='State', varid='T', prn=r'$T$',\
                desc="Greenhouse air temperature", units= C , val=20, rec=nrec) #T2 nos interesa
    ...
    class Ci_rhs(StateRHS):
        ...
        def __init__( self ):
            ...
            self.AddVar( typ='State', varid='C1', prn=r'$C_1$',\
               ...
               units= mu_mol_CO2 * mol_air**-1, val=180) # C1 nos interesa
    ...
    Model.AddVarLocal( typ='State', varid='H', prn=r'$H_k$',\
               desc="Accumulated weight of all harvested fruits.", units= g, val=0.0) # peso total de los pepinos
