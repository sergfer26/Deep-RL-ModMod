...
######### C1 ##############
### Símbolos
mt, mg, m, C, s, W, mg_CO2, J, g, mol_CH2O = symbols('mt mg m C s W mg_CO2 J g mol_CH2O') # Symbolic use of base phisical units
...
def Sol_Climate(U, theta, nmrec, Inf=True): 
    """
    ...
    ###########################
    # Base y valores iniciales#
    ###########################
    if (Inf==True):
        base_inputs = "Read_Inputs_Inf.xls" 
        C1_in = 432
        V1_in = 14
        T2_in = 20
    else:
        base_inputs = "Read_Inputs_Pre.xls" 
        C1_in = 496.8
        V1_in = 14.7425
        T2_in = 20.9
    ...
    class C1_rhs(StateRHS):
        ...
        def RHS( self, Dt):
            ...
            o_4 = o4( I11=self.V('I11'), I12=self.V('I12'), I13=self.V('I13'), psi3=self.V('psi3') )
    ...
    class V1_rhs(StateRHS):
        ...
        def __init__( self ):
            ...
            self.AddVar( typ='State', varid='T1', prn=r'$T_1$',\
                        desc="Canopy temperature", units= C , val=20, rec=nrec) # falta valor inicial
        ...
        def RHS( self, Dt):
            ...
            q_7 = q7( I14=self.V('I14'), delta1=self.V('delta1'), gamma5=self.V('gamma5') )
            ...
            q_6 = q6( I6=self.V('I6') )
            q_10 = q10( I14=self.V('I14'), delta2=self.V('delta2'), delta3=self.V('delta3') )
            q_3 = q3( I14=self.V('I14'), gamma4=self.V('gamma4'), q4=q_4, q5=q_5, q10=q_10 )
            ...
            h_3 = h3( T2=self.V('T2'), V1=self.V('V1'), U3=self.V('U3'), I6=self.V('I6'), lamb1=self.V('lamb1'), lamb2=self.V('lamb2'), alpha6=self.V('alpha6'), gamma2=self.V('gamma2'), q6=q_6 )
            #### Principal functions ####
            ...
            p_5 = p5( T2=self.Vk('T2'), V1=self.Vk('V1'), I5=self.V('I5'), psi1=self.V('psi1'), omega2=self.V('omega2'), f2=f_2, f3=f_3, f4=f_4 )
    ...
    class T1_rhs(StateRHS):
        ...
        def RHS( self, Dt):
            ...
            r_6 = r6( T1=self.Vk('T1'), I3=self.V('I3'), alpha3=self.V('alpha3'), epsil1=self.V('epsil1'), epsil2=self.V('epsil2'), lamb=self.V('lamb'), g1=g_1 )
            h_1 = h1( T1=self.Vk('T1'), T2=self.Vk('T2'), I1=self.V('I1'), alpha4=self.V('alpha4') )
            l_1 = l1( gamma2=self.V('gamma2'), p1=p_1 )
            r_7 = r7( T1=self.Vk('T1'), I4=self.V('I4'), epsil2=self.V('epsil2'), epsil3=self.V('epsil3'), lamb=self.V('lamb'), a1=a_1, g2=g_2 )
    ...
    class T2_rhs(StateRHS):
        ...
        def RHS( self, Dt):
            ...
            r_11 = r11( T2=self.Vk('T2'), I4=self.V('I4'), lamb=self.V('lamb'), epsil3=self.V('epsil3'), epsil4=self.V('epsil4'), g3=g_3 )
            r_12 = r12( T2=self.Vk('T2'), I4=self.V('I4'), lamb=self.V('lamb'), epsil3=self.V('epsil3'), epsil5=self.V('epsil5'), g4=g_4 )
            r_13 = r13( T2=self.Vk('T2'), I4=self.V('I4'), lamb=self.V('lamb'), epsil3=self.V('epsil3'), epsil6=self.V('epsil6') )
            #### Principal functions ####
    ...
    Dir.Run( Dt=1, n=nmrec, sch=Dir.sch ) # Attention: n must be equal to nrec in the RHSs
    return Dir.OutVar('C1'), Dir.OutVar('V1'), Dir.OutVar('T1'), Dir.OutVar('T2') 
...
# Símbolos
C, g, m, d, mu_mol_phot, mu_mol_CO2, mol_air, mt, pa = symbols('C g m d mu_mol_phot mu_mol_CO2 mol_air mt pa') # Symbolic use of base phisical units

def OutData(nmrec):
    """
    Retorna los datos de Holanda, cada minuto
    desde cero hasta el minuto nmrec.
    Los datos se entregan en este orden: (C1, V1, T2)
    """
    Dir1 = Director( t0=0.0, time_unit=mt, Vars={}, Modules={} )
    nrec = nmrec
    ### Add variables manually ...
    ### these typically will be first defined by other modules, RHss
    ### and already available in the Director
    Dir1.AddVar( typ='State', varid='T2_H', prn=r'$T2_H$',\
            desc="Temperature", units= C , val=20, rec=nrec)
    Dir1.AddVar( typ='State', varid='C1_H', prn=r'$C1_H$',\
                desc="CO2 concentration", units= mu_mol_CO2 * mol_air**-1, val=432, rec=nrec)
    Dir1.AddVar( typ='State', varid='V1_H', prn=r'$V1_H$',\
                desc="Vapour pressure in the air", units= pa, val=14, rec=nrec)
    ### Add an instance of Module 1:
    Dir1.AddModule( 'Climate', \
        ReadModule( "Read_Data.xls", t_conv_shift=0.0, t_conv=1.  )) # The data base time is in minutes 
    Dir1.sch = [ 'Climate' ]       
    Dir1.Run( Dt=1, n=nrec, sch= Dir1.sch)
    return Dir1.OutVar('C1_H'), Dir1.OutVar('V1_H'), Dir1.OutVar('T2_H')
